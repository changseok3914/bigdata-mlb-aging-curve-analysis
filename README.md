...
3. Statcast 데이터
   - 투구 단위 또는 타구 단위 데이터
   - 구속, 타구 속도, 발사각, 이벤트 결과, 베트스피드, RPM 등
...
Python과 pybaseball을 활용하여 MLB 공개 데이터를 수집한다.
...
- MLB 시즌별 투수 성적 데이터
- 선수 기본 정보 데이터
- Statcast 기반 타구 속도, 배트 스피드, 구속, RPM 등 세부 지표

분석 기간은 2015년부터 2025년까지의 MLB 시즌 데이터를 기준으로 설정할 예정이다. 데이터는 연도별 또는 월별 CSV 파일로 나누어 저장한다.
